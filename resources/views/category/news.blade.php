    ...
    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 no-padding"> 
        <div class="fluid_container" style="height: 250px;">            
          <div class="camera_violet_skin" id="camera_wrap_1">
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc1.png')!!}" data-src="{!!url('public/images/slides/qc1.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Sắm Apple giá tốt, Du lịch châu âu. <em>Event mua hàng Apple Tại Thế Giới Di Động</em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc2.png')!!}" data-src="{!!url('public/images/slides/qc2.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Sony trả góp 0%, có cỏ hội trúng Tivi 4K <em> Dành cho sản phẩm sony Tại Thế Giới Di Động </em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc3.png')!!}" data-src="{!!url('public/images/slides/qc3.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Thế Giới Di Động </em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc4.png')!!}" data-src="{!!url('public/images/slides/qc4.png')!!}">
                <div class="camera_caption fadeFromBottom">
                    Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Thế Giới Di Động </em>
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc5.png')!!}" data-src="{!!url('public/images/slides/qc5.png')!!}">
                <div class="camera_caption fadeFromBottom">
                     Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Thế Giới Di Động </em>)
                </div>
            </div>
            <div class="img-responsive" data-thumb="{!!url('public/images/slides/thumbs/qc6.jpg')!!}" data-src="{!!url('public/images/slides/qc6.jpg')!!}">
                <div class="camera_caption fadeFromBottom">
