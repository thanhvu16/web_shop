          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding">
            <div class="thumbnail mobile">              
              ...
              <div class="ct">
                ...
                <span class="btn label-warning"><strong>{{number_format($row->price,0,',','.')}} đ</strong>  </span>
            ...
            <div class="thumbnail">          
              <div class="hienthi">
                ...
                <div class="caption">
                  ...
                  <p>
                    <span class="btn label-warning">Giá : <strong>{{number_format($row->price,0,',','.')}} đ</strong>  </span>
                  </p>
                </div>
              </div>
              <div class="tomtat">
                <div class="thongtin">
                  ...
                  <div class="price">  
                    <span class="btn btn-info btn-block ">Giá : <strong>{{number_format($row->price,0,',','.')}} đ</strong> </span>
